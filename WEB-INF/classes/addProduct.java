...
public class addProduct extends HttpServlet {
  ...
  public void doGet(HttpServletRequest request,
      ...
      if(tvSession ==  null){
        ...
        Integer product_id = MySQLDataStoreUtilities.ProductCount() + 1;
...
out.println("<h2 style=\"color:green;\">Below Product added to the inventory</h2><BR>");

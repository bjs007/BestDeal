...
public class Tablet extends HttpServlet {
 ...
 try{
	...
	String productXmlFileName = "C:/apache-tomcat-7.0.34/webapps/BestDeal/WEB-INF/classes/TabletCatalog.xml";
        ...
        "/BestDeal/OrderPage";
		  formURL = response.encodeURL(formURL);
			...
			out.println("<table>");
				out.println("<tr>");
					out.println("<td>");
						out.println("<img src=" +request.getContextPath()+"/images/tablet/"+prd.getImage());

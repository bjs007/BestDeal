...
public class Tv extends HttpServlet {
 ...
 try{
	...
	String productXmlFileName = "C:/apache-tomcat-7.0.34/webapps/BestDeal/WEB-INF/classes/TvCatalog.xml";
		  ...
		  formURL = response.encodeURL(formURL);
           ...
           "       VALUE=\"" + prd.getId()+"\">");
			...
			out.println("<table>");
				out.println("<tr>");
					out.println("<td>");
						out.println("<img src=" +request.getContextPath()+"/images/tv/"+prd.getImage());
